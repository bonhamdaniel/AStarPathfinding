...
public class Node {
	...
	private int cost;// represents the cost associated with moving across the Game tile
	...
	public Node() {
		this.cost = -1;// assigns a cost of -1, used as a marker value
	}// Node() constructor
	
	// Node constructor - position of the tile, image of entity, cost to cross, Connections to other tiles
	public Node (Point tile, Image image, int cost) {
		...
		this.cost = cost;// sets the cost to cross the tile
	...
	public int getCost() {
		return this.cost;// returns the cost of the tile
	}// getCost() method
